...
public class PreDexTransform extends Transform {
    ...
    public PreDexTransform(Project project1) {
        ...
        def libPath = project.project(":hack").buildDir.absolutePath.concat("/intermediates/aar_main_jar/debug/classes.jar")
        println libPath
        Inject.appendClassPath(libPath)
        Inject.appendClassPath("/Applications/dev/android/sdk/android-sdk-macosx/platforms/android-30/android.jar")
    }
    @Override
    String getName() {
        return "preDex"
    ...
    void transform(Context context, Collection<TransformInput> inputs, Collection<TransformInput> referencedInputs, TransformOutputProvider outputProvider, boolean isIncremental) throws IOException, TransformException, InterruptedException {
        ...
        project.logger.error("transform===========>in");
        // 遍历transfrom的inputs
